            ...
            with gr.TabItem("🎨 Bilderzeugung"):
                with gr.Row():
                    with gr.Column():
                        ...
                        # ACTION BUTTONS
                        with gr.Row():
                            # 1. Download: Hidden file component for proper download
                            g_download_file = gr.File(visible=False, label="Download")
                ...
                # 2. Download button triggers file component
                g_download_btn.click(
                    trigger_download,
                    inputs=[g_img_path],
                    outputs=[g_download_file]
                )
