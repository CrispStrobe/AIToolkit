...
def update_t_ui(prov, force_all=False):
    ...
    # We use a dark container with explicit white text to ensure readability
    # added margin-top to align visually with the dropdown input field
    styled_badge = f"""
    <div style="
    ...
    # Return: Badge, Model Update, Whisper Options Visibility
    return (
        styled_badge,
            ...
            with gr.TabItem("🎙️ Transkription"):
                with gr.Row():
                    with gr.Column():
                        ...
                        with gr.Group():
                            with gr.Row(): # Align items vertically centered
                                # 1. Engine Dropdown (Cleaner than Radio)
                                t_prov = gr.Dropdown(
                                ...
                                # 2. Compliance Badge (Now in the middle)
                                t_badge = gr.HTML(
                                ...
                                # 3. Diarization Checkbox (Right side)
                                t_diar = gr.Checkbox(
                                    value=True, 
